...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMovieSceneAkTrack()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsAMasterTrack = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsAMasterTrack", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UMovieSceneAkTrack), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsAMasterTrack_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsAMasterTrack_MetaData, ARRAY_COUNT(NewProp_bIsAMasterTrack_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMovieSceneAkTrack, 337303543);
