...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UAkAudioEvent()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_MinimumDuration = { UE4CodeGen_Private::EPropertyClass::Float, "MinimumDuration", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000014, 1, nullptr, STRUCT_OFFSET(UAkAudioEvent, MinimumDuration), METADATA_PARAMS(NewProp_MinimumDuration_MetaData, ARRAY_COUNT(NewProp_MinimumDuration_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_IsInfinite = { UE4CodeGen_Private::EPropertyClass::Bool, "IsInfinite", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000014, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UAkAudioEvent), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_IsInfinite_SetBit)>::SetBit, METADATA_PARAMS(NewProp_IsInfinite_MetaData, ARRAY_COUNT(NewProp_IsInfinite_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAkAudioEvent, 3505780842);
