...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Room = { UE4CodeGen_Private::EPropertyClass::Object, "Room", RF_Public|RF_Transient|RF_MarkAsNative, 0x00100000000a001d, 1, nullptr, STRUCT_OFFSET(AAkSpatialAudioVolume, Room), Z_Construct_UClass_UAkRoomComponent_NoRegister, METADATA_PARAMS(NewProp_Room_MetaData, ARRAY_COUNT(NewProp_Room_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_LateReverb = { UE4CodeGen_Private::EPropertyClass::Object, "LateReverb", RF_Public|RF_Transient|RF_MarkAsNative, 0x00100000000a001d, 1, nullptr, STRUCT_OFFSET(AAkSpatialAudioVolume, LateReverb), Z_Construct_UClass_UAkLateReverbComponent_NoRegister, METADATA_PARAMS(NewProp_LateReverb_MetaData, ARRAY_COUNT(NewProp_LateReverb_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_SurfaceReflectorSet = { UE4CodeGen_Private::EPropertyClass::Object, "SurfaceReflectorSet", RF_Public|RF_Transient|RF_MarkAsNative, 0x00100000000a001d, 1, nullptr, STRUCT_OFFSET(AAkSpatialAudioVolume, SurfaceReflectorSet), Z_Construct_UClass_UAkSurfaceReflectorSetComponent_NoRegister, METADATA_PARAMS(NewProp_SurfaceReflectorSet_MetaData, ARRAY_COUNT(NewProp_SurfaceReflectorSet_MetaData)) };
	...
	IMPLEMENT_CLASS(AAkSpatialAudioVolume, 236419157);
